...
- 预装「已归档会话」管理和对话刻度尺（[dsh-plugin-atlas](https://github.com/qinyre/dsh-plugin-atlas)）：侧边栏底部打开归档面板，浏览、预览、一键恢复归档的会话，还可以配置自动归档规则；对话区左缘的刻度尺每格对应一次发言，悬停预览、点击跳转、Alt+↑/↓ 逐条移动。
