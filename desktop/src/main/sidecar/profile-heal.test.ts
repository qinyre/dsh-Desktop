...
describe('repairSpecFromManifest', () => {
  it('pins to the declared dependency version (restore last known good)', () => {
    expect(repairSpecFromManifest(MANIFEST, 'dsh-plugin-capabilities')).toBe('dsh-plugin-capabilities@0.2.1')
  })
...
describe('BundleBrickHealer', () => {
  it('repairs with the pinned spec and announces recovery', async () => {
    ...
    expect(fx.repair).toHaveBeenCalledWith('dsh-plugin-capabilities', 'dsh-plugin-capabilities@0.2.1')
